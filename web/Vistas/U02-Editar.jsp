        ...
        <div id="customers">
            ...
            <form action="../U02_Controlador" method="post">
                <table border="2">
                    ...
                    <tbody>
                        <tr>                           
                            <td> <input type="hidden" name="txtEmbarque" value="<%=en.getEmbarque()%>"/> </td>
                        </tr>
                        <tr>                           
                            <td> <input type="hidden" name="txtLlegada" value="<%=en.getLlegada()%>"/> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>                            
                            <td> <input type="hidden" name="txtDescripcion" value="<%=en.getDescripcion()%>"/> </td>
                        </tr>
                        <tr>
